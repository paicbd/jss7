 ...
 */
@Deprecated
public class ShellServerWildFlyLegacy extends ShellServer {

  private JBossCachedAuthenticationManager jbossAuthManagement = null;

  public ShellServerWildFlyLegacy(Scheduler scheduler, List<ShellExecutor> shellExecutors) throws IOException {
